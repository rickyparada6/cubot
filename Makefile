MY_MODULES = timer.o gpio.o strings.o printf.o backtrace.o malloc.o keyboard.o shell.o fb.o gl.o console.o gpio_interrupts.o interrupts_asm.o bits_asm.o cube.o algorithms.o motors.o calibrate.o solver.o commutators.o
...
# Paths to binaries.
APPLICATION = build/bin/cube_solver.bin
TEST 		= build/bin/test_cube.bin
CALIBRATION = build/bin/calibrate_motors.bin
...
all: $(APPLICATION) $(TEST) $(CALIBRATION)
...
# Build and run the calibration binary.
calibrate: $(CALIBRATION) | build
	rpi-install.py -p $<
